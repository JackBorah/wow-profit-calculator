...
urlpatterns = [
    path('', views.ProfessionIndexView.as_view(), name='select-profession'),
    path('<profession>/', views.ProfessionCategoriesView.as_view(), name='select-recipe-category'),
    path('<str:profession>/<category>/<int:pk>/', views.RecipeCalculatorView.as_view(), name='recipe-calculator'),
